...
**Частота битовых ошибок для полярных кодов. Все коды имеют скорость R=0.5. Длина полярного кода равна N=2048, а длина кода WiMax равна N=2304. Использованный размер списка L = 32. CRC c длиной 16 бит**

<img width="652" height="282" alt="1" src="https://github.com/user-attachments/assets/558429fc-290b-4dd3-95ee-3bc6bbaca0e6" />


**Графики зависимостей BER от SNR при N=512,K=448,R=0.875. Сплошной красной линией - алгоритм SC, пунктирной линией – алгоритм SCL, точечной линией – алгоритм CA-SCL. (красным – L = 1, зелёным – L = 2, синим – L = 4, розовым – L = 8, фиолетовым – L = 16)**

<img width="1704" height="947" alt="2" src="https://github.com/user-attachments/assets/8b51b928-5f1b-4df8-a38f-289220be6869" />
