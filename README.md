...
**Графики зависимостей BER от SNR для K = 256 N = 518 Trel = 8 Poly = {13,15} (красным – L = 1, зелёным – L = 2, синим – L = 4, розовым – L = 8, фиолетовым – L = 16)**

<img width="1656" height="915" alt="111111111111111" src="https://github.com/user-attachments/assets/b70578bb-c1dc-4b51-b36d-b6f5b160c832" />
